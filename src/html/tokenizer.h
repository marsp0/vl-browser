...
typedef enum
{
    ...
    HTML_TOKENIZER_EOF_IN_TAG,
    HTML_TOKENIZER_INCORRECTLY_CLOSED_COMMENT,
    HTML_TOKENIZER_INCORRECTLY_OPENED_COMMENT,
    HTML_TOKENIZER_INVALID_CHARACTER_SEQUENCE_AFTER_DOCTYPE_NAME,
    HTML_TOKENIZER_INVALID_FIRST_CHARACTER_OF_TAG_NAME,
    HTML_TOKENIZER_MISSING_ATTRIBUTE_VALUE,
    HTML_TOKENIZER_MISSING_DOCTYPE_NAME,
    HTML_TOKENIZER_MISSING_DOCTYPE_PUBLIC_IDENTIFIER,
    HTML_TOKENIZER_MISSING_DOCTYPE_SYSTEM_IDENTIFIER,
    HTML_TOKENIZER_MISSING_END_TAG_NAME,
    HTML_TOKENIZER_MISSING_QUOTE_BEFORE_DOCTYPE_PUBLIC_IDENTIFIER,
    HTML_TOKENIZER_MISSING_QUOTE_BEFORE_DOCTYPE_SYSTEM_IDENTIFIER,
    HTML_TOKENIZER_MISSING_SEMICOLON_AFTER_CHARACTER_REFERENCE,         // todo: test
    HTML_TOKENIZER_MISSING_WHITESPACE_AFTER_DOCTYPE_PUBLIC_KEYWORD,
    HTML_TOKENIZER_MISSING_WHITESPACE_AFTER_DOCTYPE_SYSTEM_KEYWORD,
    HTML_TOKENIZER_MISSING_WHITESPACE_BEFORE_DOCTYPE_NAME,
    HTML_TOKENIZER_MISSING_WHITESPACE_BETWEEN_ATTRIBUTES,
    HTML_TOKENIZER_MISSING_WHITESPACE_BETWEEN_DOCTYPE_PUBLIC_AND_SYSTEM_IDENTIFIERS,
    HTML_TOKENIZER_NESTED_COMMENT,
    HTML_TOKENIZER_NONCHARACTER_CHARACTER_REFERENCE,
    HTML_TOKENIZER_NULL_CHARACTER_REFERENCE,
    HTML_TOKENIZER_SURROGATE_CHARACTER_REFERENCE,
    HTML_TOKENIZER_UNEXPECTED_CHARACTER_AFTER_DOCTYPE_SYSTEM_IDENTIFIER,
    HTML_TOKENIZER_UNEXPECTED_CHARACTER_IN_ATTRIBUTE_NAME,
    HTML_TOKENIZER_UNEXPECTED_CHARACTER_IN_UNQUOTED_ATTRIBUTE_VALUE,
    HTML_TOKENIZER_UNEXPECTED_EQUALS_SIGN_BEFORE_ATTRIBUTE_NAME,
